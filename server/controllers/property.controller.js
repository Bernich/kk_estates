...
//Extracting  a singular property
...
const createProperty = async(req, res) => {
    ...
    try {
        //start a new session.... session ensure what in create property session is atomic it can stop and it can start
...
const deleteProperty = async(req, res) => {
    try {
        ...
        res.status(200).json({ message: "Property deleted successffully" });
    } catch (error) {
        res.status(500).json({ message: error.message });
    }
};
